...
public class MyIssues extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.my_issues_toolbar);
        ...
        listViewLostFound = findViewById(R.id.my_issues_list_view);
        ...
        listViewLostFound.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MyIssues.this, IssueDetails.class);
    ...
    private void getData() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                IssueAdapter detailsAdapter = new IssueAdapter(MyIssues.this, issueList);
